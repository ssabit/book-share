	...
	<div class="container">
		<div class="row">
			<div class="col-md-3">
				...
				<a href="../profile/profile.php" class="list-group-item list-group-item-action">Profile</a>
					...
					<a href="#" class="list-group-item list-group-item-action active">My Posts</a>
					<a href="../requests/history.php" class="list-group-item list-group-item-action">History</a>
					<a href="forum.php" class="list-group-item list-group-item-action ">Forum</a>
				</div>
			</div>
			<div class="col-md-9">
				<div class="card">
	 ...
	 <?php 
        while($row = mysqli_fetch_array($result)) {         
			...
			echo "<tr >";
			echo "<td colspan='11'>"."Posted By -".$row['post_owner']."<br><br>"."Published on - ".$row['time']."<br><br>"."Book Name: ".$row['book_name']."<br><br>"."Genre: ".$row['post_genre']."<br><br>".$row['status']
			...
			echo "<td><a href=\"delete_post.php?id=$row[post_id]\" onClick=\"return confirm('Are you sure you want to delete?')\"><span class='glyphicon glyphicon-trash'></span></a></td>";
			 echo "</tr>";
