							...
							<div class="col-md-12">
								<form action="user_edit.php" method="post">
									<div class="form-group row">
										...
										<div class="col-8">
											<input id="username" name="username" placeholder="" class="form-control here" type="text" value="<?php echo $username;?>" readonly>
										</div>
									</div>
									<div class="form-group row">
                                                                            <label for="level" class="col-4 col-form-label">User Level <span style="color:red;">*</span></label>
										<div class="col-8">
									...
									<div class="form-group row">
										<label for="password" class="col-4 col-form-label">Password<span style="color:red;">*</span></label>
										<div class="col-8">
									...
									<div class="form-group row">
										<label for="email" class="col-4 col-form-label">Email<span style="color:red;">*</span></label>
										<div class="col-8">
